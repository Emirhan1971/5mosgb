...
if (isset($_POST["delete"])) {
    ...
    $sql = "DELETE from videos where videoID=?" ;
            try {
                ...
                if ($sonuc) {
                    echo "<p style='background-color:green; color:white;'>video başarılı bir şekilde silinde.</p>";
                }
...
?>
    ...
    <div class="form-container">
        <div class="processes">
            ...
            <hr>
            <h3 style="text-align:center; font-size:50px; color:black;">video sil</h3><br>
            <form action="" method="POST">
                <input class="form-control" type="number" name="videoID" placeholder="Silmek istediğiniz video no giriniz."
                    required><br>
